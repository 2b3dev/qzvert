            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                ...
                <span className="text-foreground font-semibold">
                  {t('about.hero.subtitleHighlight')}
                </span>{' '}
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative p-8 md:p-12 rounded-3xl bg-linear-to-br from-card to-primary/5 border border-primary/20 overflow-hidden"
            >
              ...
              <div className="relative">
                ...
                <p className="text-lg md:text-xl text-foreground leading-relaxed">
                  ...
                  <span className="text-primary font-bold">
                    {t('about.mission.highlight1')}
                  </span>{' '}
                  {t('about.mission.text2')}
                  <span className="text-primary font-bold">
                    {' '}
                    {t('about.mission.highlight2')}
                  </span>
                </p>
              </div>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {coreValues.map((value, index) => (
                ...
                >
                  {/* Background Glow */}
                  <div
                    className={`absolute top-0 right-0 w-40 h-40 ${value.bgColor} rounded-full blur-3xl`}
                  />

                  <div className="relative">
                    {/* Icon */}
                    <div
                      className={`w-16 h-16 rounded-2xl bg-linear-to-br ${value.color} flex items-center justify-center mb-6`}
                    >
                    ...
                    <p
                      className={`text-sm font-medium mb-4 bg-linear-to-r ${value.color} bg-clip-text text-transparent`}
                    >
                      {value.titleThai}
                    </p>
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                ...
                <span className="text-primary">
                  {t('about.stats.titleHighlight')}
                </span>
                {t('about.stats.titleEnd')}
              </h2>
            </motion.div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                ...
                <span className="text-primary">
                  {t('about.drives.titleHighlight')}
                </span>
                {t('about.drives.titleEnd')}
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
