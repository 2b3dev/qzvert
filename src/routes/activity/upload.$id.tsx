...
function ActivityUploadPage() {
  ...
  const isLesson = currentActivity.type === 'lesson'
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      let updatedQuest
      if (isLesson) {
        updatedQuest = { ...currentActivity, title, description, thumbnail: finalThumbnail, tags, modules: lessonModules }
      } else if (isSmartQuiz) {
        updatedQuest = { ...currentActivity, title, description, thumbnail: finalThumbnail, tags, quizzes }
      } else {
        updatedQuest = { ...currentActivity, title, description, thumbnail: finalThumbnail, tags }
      }
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-xl font-bold text-foreground">
                Edit {isLesson ? 'Lesson' : isSmartQuiz ? 'Quiz' : 'Quest'}
              </h1>
              <StatusDropdown
                value={status}
                onChange={setStatus}
      ...
      <div className="max-w-4xl mx-auto py-8 px-6">
        ...
        {/* Total Points - Hidden for Lessons */}
        {!isLesson && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {/* Lesson Modules - Only for Lessons */}
        {isLesson && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {/* Questions List - Hidden for Lessons */}
        {!isLesson && (
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
